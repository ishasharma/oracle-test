...
Ext
		.define(
				'Repotest.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Repotest.view.logger.tabs.details.DetailsTab',
							'Repotest.view.logger.tabs.fileconnector.FileConnectorTab',
							'Repotest.view.logger.tabs.dbconnector.DBConnectorTab',
							'Repotest.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Repotest.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Repotest.view.logger.LogConfigurationTabPanelController',
