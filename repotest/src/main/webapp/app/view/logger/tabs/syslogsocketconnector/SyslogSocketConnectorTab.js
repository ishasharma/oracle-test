 ...
 * 
 */
Ext.define('Repotest.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Repotest.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
