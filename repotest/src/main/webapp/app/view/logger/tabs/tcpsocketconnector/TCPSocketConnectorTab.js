...
Ext
		.define(
				'Repotest.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Repotest.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],
