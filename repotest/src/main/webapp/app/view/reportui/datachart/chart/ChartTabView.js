Ext.define('Repotest.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Repotest.view.reportui.datachart.chart.RatingField','Repotest.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
