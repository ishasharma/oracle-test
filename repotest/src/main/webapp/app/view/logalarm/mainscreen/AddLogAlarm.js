 ...
 * 
 */
Ext.define('Repotest.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Repotest.view.logalarm.mainscreen.AddLogAlarmController',
			'Repotest.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Repotest.view.logalarm.mainscreen.AppAlarmPanel',
