Ext
		.define(
				'Repotest.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Repotest.view.searchengine.search.SearchEngineMainPanelController','Repotest.view.searchengine.search.PanelHeaderField' ,'Repotest.view.searchengine.search.ReportGridView','Repotest.view.searchengine.search.ReportChartView','Repotest.view.searchengine.search.documentView','Repotest.view.searchengine.search.DouMeanView','Repotest.view.googlemaps.map.MapPanel'],
