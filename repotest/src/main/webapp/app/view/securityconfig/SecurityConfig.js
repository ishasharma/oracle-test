 ...
 * 
 */
Ext.define('Repotest.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Repotest.view.securityconfig.SecurityConfigController',
			'Repotest.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
