 ...
 */
Ext.define('Repotest.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Repotest.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Repotest.view.fw.component.DateTimePicker(o);
    },
