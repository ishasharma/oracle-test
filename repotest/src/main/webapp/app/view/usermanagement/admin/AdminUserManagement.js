Ext.define('Repotest.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Repotest.view.usermanagement.admin.UserPasswordReset',
	            'Repotest.view.usermanagement.admin.AddUserDetails',
	            'Repotest.view.usermanagement.admin.ViewUser'],
