Ext.define('Repotest.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Repotest.view.usermanagement.admin.AddUserDetailsViewModel', 'Repotest.model.AddUserDataModel' ],
