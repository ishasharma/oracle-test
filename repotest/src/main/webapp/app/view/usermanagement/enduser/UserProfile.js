Ext.define('Repotest.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Repotest.view.usermanagement.enduser.UserProfileController', 'Repotest.view.usermanagement.admin.AddUserDetailsViewModel', 'Repotest.model.AddUserDataModel' ],
