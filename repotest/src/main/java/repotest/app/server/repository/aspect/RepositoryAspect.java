package repotest.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* repotest.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* repotest.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* repotest.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* repotest.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* repotest.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* repotest.app.server.repository..*(..))")
