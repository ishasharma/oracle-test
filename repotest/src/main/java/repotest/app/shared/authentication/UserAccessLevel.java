...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "UserAccessLevel", complexity = Complexity.LOW)
...
public class UserAccessLevel implements Serializable, CommonEntityInterface, Comparator<UserAccessLevel> {
    ...
    public boolean equals(Object obj) {
        try {
            repotest.app.shared.authentication.UserAccessLevel other = (repotest.app.shared.authentication.UserAccessLevel) obj;
            if (userAccessLevelId == null) {
                return false;
