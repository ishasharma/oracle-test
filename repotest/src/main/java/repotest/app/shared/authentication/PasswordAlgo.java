...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "PasswordAlgo", complexity = Complexity.LOW)
...
public class PasswordAlgo implements Serializable, CommonEntityInterface, PasswordAlgoInterface, Comparator<PasswordAlgo> {
    ...
    public boolean equals(Object obj) {
        try {
            repotest.app.shared.authentication.PasswordAlgo other = (repotest.app.shared.authentication.PasswordAlgo) obj;
            if (algoId == null) {
                return false;
