...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "root", versionNumber = "2", comments = "UserData", complexity = Complexity.LOW)
...
public class UserData implements Serializable, CommonEntityInterface, UserDataInterface, Comparator<UserData> {
    ...
    public boolean equals(Object obj) {
        try {
            repotest.app.shared.authentication.UserData other = (repotest.app.shared.authentication.UserData) obj;
            if (userDataId == null) {
                return false;
