...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "LoginSession", complexity = Complexity.LOW)
public class LoginSession implements Serializable, CommonEntityInterface, LoginSessionInterface, Comparator<LoginSession> {
    ...
    public boolean equals(Object obj) {
        try {
            repotest.app.shared.authentication.LoginSession other = (repotest.app.shared.authentication.LoginSession) obj;
            if (appSessionId == null) {
                return false;
