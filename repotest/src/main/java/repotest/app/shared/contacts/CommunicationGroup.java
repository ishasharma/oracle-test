...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "CommunicationGroup", complexity = Complexity.LOW)
...
public class CommunicationGroup implements Serializable, CommonEntityInterface, Comparator<CommunicationGroup> {
    ...
    public boolean equals(Object obj) {
        try {
            repotest.app.shared.contacts.CommunicationGroup other = (repotest.app.shared.contacts.CommunicationGroup) obj;
            if (commGroupId == null) {
                return false;
