...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "Title", complexity = Complexity.LOW)
...
public class Title implements Serializable, CommonEntityInterface, Comparator<Title> {
    ...
    public boolean equals(Object obj) {
        try {
            repotest.app.shared.contacts.Title other = (repotest.app.shared.contacts.Title) obj;
            if (titleId == null) {
                return false;
