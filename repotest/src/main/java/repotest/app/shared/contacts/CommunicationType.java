...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "CommunicationType", complexity = Complexity.LOW)
...
public class CommunicationType implements Serializable, CommonEntityInterface, Comparator<CommunicationType> {
    ...
    public boolean equals(Object obj) {
        try {
            repotest.app.shared.contacts.CommunicationType other = (repotest.app.shared.contacts.CommunicationType) obj;
            if (commType == null) {
                return false;
