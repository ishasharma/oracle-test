...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "AddressExtended", complexity = Complexity.LOW)
...
public class AddressExtended implements Serializable, CommonEntityInterface, Comparator<AddressExtended> {
    ...
    public boolean equals(Object obj) {
        try {
            repotest.app.shared.location.AddressExtended other = (repotest.app.shared.location.AddressExtended) obj;
            if (addExtId == null) {
                return false;
