...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "Taluka", complexity = Complexity.LOW)
...
public class Taluka implements Serializable, CommonEntityInterface, Comparator<Taluka> {
    ...
    public boolean equals(Object obj) {
        try {
            repotest.app.shared.location.Taluka other = (repotest.app.shared.location.Taluka) obj;
            if (talukaId == null) {
                return false;
