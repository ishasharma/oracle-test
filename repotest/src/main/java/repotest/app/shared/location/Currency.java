...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "Currency", complexity = Complexity.LOW)
...
public class Currency implements Serializable, CommonEntityInterface, Comparator<Currency> {
    ...
    public boolean equals(Object obj) {
        try {
            repotest.app.shared.location.Currency other = (repotest.app.shared.location.Currency) obj;
            if (currencyId == null) {
                return false;
