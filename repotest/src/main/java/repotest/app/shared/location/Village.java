package repotest.app.shared.location;
...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "Village", complexity = Complexity.LOW)
...
public class Village implements Serializable, CommonEntityInterface, Comparator<Village> {
    ...
    public void setVillageLatitude(String _villageLatitude) {
    ...
    public boolean equals(Object obj) {
        try {
            repotest.app.shared.location.Village other = (repotest.app.shared.location.Village) obj;
            if (villageId == null) {
                return false;
