...
sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/alter_ast_Currency_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/alter_ast_State_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/alter_ast_Region_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/alter_ast_District_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/alter_ast_City_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/alter_ast_Taluka_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/alter_ast_Village_M.sql; 
...
sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/alter_ast_AddressExtended_TP.sql; 
