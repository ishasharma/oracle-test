...
ART_CREATE_PATH=/tmp/applifire/db/5VJPOC7D2FDIKLMY2RVZ3Q/6BE6DB6D-9D38-4A34-8DE5-68F3A79FF98C/art/create
AST_CREATE_PATH=/tmp/applifire/db/5VJPOC7D2FDIKLMY2RVZ3Q/6BE6DB6D-9D38-4A34-8DE5-68F3A79FF98C/ast/create
APPLFIREUSER=root
...
sqlplus $USER/$PASSWORD @$ART_CREATE_PATH/art_enum.sql;

sqlplus $USER/$PASSWORD @$ART_CREATE_PATH/art_enum_details.sql;

sqlplus $USER/$PASSWORD @$ART_CREATE_PATH/art_report_ui.sql;

sqlplus $USER/$PASSWORD @$ART_CREATE_PATH/art_table_details.sql;

sqlplus $USER/$PASSWORD @$ART_CREATE_PATH/art_table_field_details.sql;

sqlplus $USER/$PASSWORD @$ART_CREATE_PATH/art_table_entity_relation.sql;

sqlplus $USER/$PASSWORD @$ART_CREATE_PATH/art_database_aggregate.sql;

sqlplus $USER/$PASSWORD @$ART_CREATE_PATH/art_database_function.sql;

sqlplus $USER/$PASSWORD @$ART_CREATE_PATH/art_database_operators.sql;
...
sqlplus $USER/$PASSWORD @$ART_CREATE_PATH/art_service.sql;

sqlplus $USER/$PASSWORD @$ART_CREATE_PATH/art_service_operation.sql;
...
sqlplus $USER/$PASSWORD @$ART_CREATE_PATH/art_rules.sql;
...
sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/ast_Currency_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/ast_State_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/ast_Region_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/ast_District_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/ast_City_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/ast_Taluka_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/ast_Village_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/ast_AddressType_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/ast_Address_T.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/ast_AddressExtended_TP.sql; 
